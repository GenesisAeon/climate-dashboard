...
(`LICENSE-CODE`), documentation under CC BY 4.0 (`LICENSE-DOCS`). Any
release artifact (sdist/wheel) must include both license files.
...
6. `.github/workflows/release.yml` builds, tests, and publishes automatically.
